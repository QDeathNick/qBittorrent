...
TransferListModel::TransferListModel(QObject *parent)
    ...
    , m_statusStrings {
          ...
          {BitTorrent::TorrentState::Moving, tr("Moving", "Torrent local data are queued to be moved/relocated")},
          {BitTorrent::TorrentState::QueuedMoving, tr("[Q] Moving", "Torrent local data are being moved/relocated")},
